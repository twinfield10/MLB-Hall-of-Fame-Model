...
#Batters
tmp <- bb %>% filter(POS!='P')
fit_df_train <- get_fit_data(tmp, final_game_min='1901-01-01', final_game_max='2011-01-01') %>%
  filter(PA_1>=30)
fit_df_test <- get_fit_data(tmp, final_game_min='2011-01-01', final_game_max='2021-12-31') %>%
  filter(PA_1>=30)
